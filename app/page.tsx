      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl items-center">
            <h1 className="text-black mb-6 text-6xl font-bold text-center">A better way to track your job application</h1>
            <p className="text-muted-foreground mb-10 text-xl text-center">Capture, organize and manage your job search in one place.</p>
